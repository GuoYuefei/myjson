...
func (v *Value)WhichNumType() (NumberType, bool) {
	...
	case int8: result = Int8
	case uint8: result = Uint8
	case float64: result = Float64
...
func (v *Value)GetAsInt() (result int, err error) {
	...
	case int: result = a
	case int8: result = int(a)
	case uint8: result = int(a)
	default:
		result = 0
...
func (v *Value)GetAsFloat64() (result float64, err error) {
	...
	if _, ok := v.WhichNumType(); ok {
		switch a := v.value.(type) {
		case float64: result = a
		case uint: result = float64(a)
		case int: result = float64(a)
		case uint8: result = float64(a)
		case int8: result = float64(a)
		default:
			result = 0
